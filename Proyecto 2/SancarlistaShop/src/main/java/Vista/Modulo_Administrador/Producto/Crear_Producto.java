...
/*
Interfaz para crear productos subventana(Producto) BotonEspecífico(Crear) MÓDULO ADMINISTRADOR
*/
...
public class Crear_Producto extends JFrame {
    ...
    public void Crear() {
        ...
        titulo = new JLabel("Crear Producto", USAC, SwingConstants.CENTER);
...
//--------------------------------------------------------------------------------------------
        ...
        crearP.setBounds(110, 500, 280, 30);
...
//-------------------------------------------------------------------------------------
    ...
    public void Genero() {
        this.setLayout(null);
        genero = new JLabel("Categoría");
        genero.setForeground(new Color(25, 25, 133));//Color del título
        genero.setBounds(50, 280, 150, 100);//Posición
    ...
    public void Contraseña() {
        ...
        contraseña.setBounds(50, 350, 200, 100);//Posición
    ...
    public void Boton() {
        ...
        ActionListener accion2 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                P8.CCCP(AA); //corregir los contadores por si hay corrimiento antes de registrar los datos
//codigo-----------------------------------------------------------------------
